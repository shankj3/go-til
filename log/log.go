/*
This is a way to have one style of logging for the project. Initialize in your service w/ InitializeLog(), uses a JSONFormatter.
...
// Log() is the default logger. Includes extra field `"function": <name>`
func Log() *log.Entry {
